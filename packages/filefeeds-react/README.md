...
> [!IMPORTANT]
> **This package is legacy.** `@oneschema/filefeeds-react` is in maintenance
> mode: it keeps working and still receives critical and security fixes, but no
> new features and no major updates are planned. If you are starting a new
