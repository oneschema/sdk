...
| `devMode`          | `boolean`                      |          |                                | Whether to launch the importer in dev mode, which shows the iframe even when launching fails and renders diagnostics in the embed instead of end-user error copy. When left unset the SDK sends nothing and OneSchema applies its own default; wire it to your own build condition to enable it during development                                                                                                                                                                                                                                                                                |
